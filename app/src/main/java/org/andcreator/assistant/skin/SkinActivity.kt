...
import org.andcreator.assistant.dialog.NightModeLevelDialog
import org.andcreator.assistant.util.AppSettings
import org.andcreator.assistant.view.NightModeView

abstract class SkinActivity : AppCompatActivity(),NightModeLevelDialog.OnLevelChangeCallback  {
    ...
    protected var skin:Skin = AssistantApplication.appSkin
        private set
    ...
    fun updateSkin(skin: Skin){
        ...
        Log.e("colorPrimary",skin.colorPrimary.toString())
        Log.e("colorAccent",skin.colorAccent.toString())
...
//        }
    ...
    override fun onStart() {
        super.onStart()
        if(lastSkinCode != AssistantApplication.appSkin.hashCode()){
            updateSkin(AssistantApplication.appSkin)
            lastSkinCode = AssistantApplication.appSkin.hashCode()
        }
    ...
    protected fun requestUpdateSkin(){
        (application as AssistantApplication).onSkinChange()
    }
    ...
    protected fun changeNightMode(){
        ...
        AppSettings.putNightMode(this,!openType)
    ...
    private fun openNightMode(){
        ...
        nightView?.level = AppSettings.getNightModeLevel(this)
    }

    private fun isNightMode(): Boolean{
        return AppSettings.isNightMode(this)
    }
