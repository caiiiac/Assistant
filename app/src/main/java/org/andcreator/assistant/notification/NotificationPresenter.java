...
public class NotificationPresenter {
    ...
    /*package*/ public NotificationPresenter(Service service, CpuConfig config) {
    ...
    /*package*/ public void updateNotifications(int[] cpuUsages, int currentCpuClock, int minFreq, int maxFreq, boolean requestForeground) {
...
//            sb.append("Cores: ");
    ...
    private NotificationCompat.Builder makeFrequencyNotification(int minFreq, int maxFreq,
        ...
        // 通知文字列の生成
        final String notificationTitle = "CPU Frequency " + CpuUtil.formatFreq(currentCpuClock);
        final String notificationContent = "Max Freq " + CpuUtil.formatFreq(maxFreq) + " Min Freq " + CpuUtil.formatFreq(minFreq);
