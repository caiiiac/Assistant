...
open class QRFinderDrawable: Drawable(),QRFinder {
     ...
     * 边框的颜色，取色为绿色
     */
    var borderColor = 0xff3d7af3.toInt()

    /**
     * 扫描线的颜色
     */
    var scanLineColor = 0xff3d7af3.toInt()
     ...
     * 可能点的颜色，用于绘制扫描框内的小点
     */
    var pointColor = 0xff3d7af3.toInt()
...
//        canvas.restore()
    ...
    private fun drawPoints(canvas: Canvas){
        ...
        //possibleResultPoints.filter{it != null}

        val possibleFilter = possibleResultPoints.filter{it != null}

        val possibleArray: Array<ResultPoint> = Array(possibleFilter.size) { it ->
            possibleFilter[it] }
